...
{
    internal class HD_Window_TagLayer : EditorWindow
    {
        #region Properties
        #region GUI
        ...
        {
            HD_Window_TagLayer window = GetWindow<HD_Window_TagLayer>("HD Tag and Layer");

            window.minSize = new(250, 95);
            Vector2 textSize = HD_Common_GUI.RegularLabelStyle.CalcSize(new(gameObject.name));
        ...
        private void OnGUI()
        {
            ...
            EditorGUILayout.BeginVertical(HD_Common_GUI.TertiaryPanelStyle);
            ...
            EditorGUILayout.LabelField($"▷ {windowLabel}", HD_Common_GUI.TabLabelStyle);
            GUILayout.Space(4);

            #region Body
            GUILayout.BeginHorizontal();
            EditorGUILayout.LabelField($"<color=#{(HD_Manager_Editor.IsProSkin ? "67F758" : "50C044")}>GameObject:</color> {gameObject.name}", HD_Common_GUI.RegularLabelStyle, GUILayout.ExpandWidth(true));
