...
namespace Verpha.HierarchyDesigner
{
    internal static class HierarchyDesigner_Manager_GameObject
    {
        ...
        private static Dictionary<int, (Color textColor, int fontSize, FontStyle fontStyle, Color folderColor, HierarchyDesigner_Configurable_Folders.FolderImageType folderImageType)> folderCache = new();
        private static Dictionary<int, (Color textColor, bool isGradientBackground, Color backgroundColor, Gradient backgroundGradient, int fontSize, FontStyle fontStyle, TextAnchor textAnchor, HierarchyDesigner_Configurable_Separators.SeparatorImageType separatorImageType)> separatorCache = new();
        ...
        private static void OnHierarchyWindowItemGUI(int instanceID, Rect selectionRect)
        {
            ...
            if (currentEvent.type != EventType.Repaint && !(gameObject.CompareTag(HierarchyDesigner_Shared_Constants.SeparatorTag) && gameObject.name.StartsWith(HierarchyDesigner_Shared_Constants.SeparatorPrefix)))
            {
            ...
            #region Features
            if (separatorCache.TryGetValue(gameObject.GetInstanceID(), out _) || (gameObject.CompareTag(HierarchyDesigner_Shared_Constants.SeparatorTag) && gameObject.name.StartsWith(HierarchyDesigner_Shared_Constants.SeparatorPrefix))) { DrawSeparator(gameObject, selectionRect, instanceID); return; }
        ...
        {
            #region Header
            if ((EditorWindow.focusedWindow != null && EditorWindow.focusedWindow.titleContent.text != HierarchyDesigner_Shared_Constants.HierarchyWindow) || HierarchyDesigner_Manager_Editor.IsPlaying && disableEditorDesignerMajorOperationsDuringPlayMode) return;
            #endregion
        ...
        private static void OnPostHeaderGUI(Editor editor)
        {
            ...
            if (separatorCache.TryGetValue(gameObject.GetInstanceID(), out _) || (gameObject.CompareTag(HierarchyDesigner_Shared_Constants.SeparatorTag) && gameObject.name.StartsWith(HierarchyDesigner_Shared_Constants.SeparatorPrefix))) { EditorGUILayout.HelpBox(separatorMessage, MessageType.Info, true); }
        ...
        private static void DrawBackground(Rect selectionRect, int instanceID)
        {
            ...
            GUI.DrawTexture(new(selectionRect.x, selectionRect.y, selectionRect.height, defaultIconSelectionHeight), HierarchyDesigner_Shared_Resources.DefaultTexture);
            GUI.color = activeColor;
        }
        ...
        private static Color SetBackgroundColorBasedOnState(Rect selectionRect, int instanceID)
        {
            ...
            if (enableDynamicBackgroundForGameObjectMainIcon)
            {
                ...
                bool isHierarchyFocused = EditorWindow.focusedWindow != null && EditorWindow.focusedWindow.titleContent.text == HierarchyDesigner_Shared_Constants.HierarchyWindow;

                if (isSelected && !isHierarchyFocused)
                {
                    return isRow ? HierarchyDesigner_Shared_Color.GetHighlightedFocusedEditorRowColor() : HierarchyDesigner_Shared_Color.GetHighlightedFocusedEditorColor();
                }
                else if (isSelected)
                {
                    return isRow ? HierarchyDesigner_Shared_Color.GetSelectedEditorRowColor() : HierarchyDesigner_Shared_Color.GetSelectedEditorColor();
                }
                else if (isHovering)
                {
                    return isRow ? HierarchyDesigner_Shared_Color.GetHighlightedEditorRowColor() : HierarchyDesigner_Shared_Color.GetHighlightedEditorColor();
                }
                return isRow ? HierarchyDesigner_Shared_Color.GetDefaultEditorRowBackgroundColor() : HierarchyDesigner_Shared_Color.GetDefaultEditorBackgroundColor();
            }
            return isRow ? HierarchyDesigner_Shared_Color.GetDefaultEditorRowBackgroundColor() : HierarchyDesigner_Shared_Color.GetDefaultEditorBackgroundColor();
        }
        ...
        private static void DrawGameObjectComponentIcons(GameObject gameObject, Rect selectionRect, int instanceID)
        {
            ...
            switch (layoutMode)
            {
                case HierarchyDesigner_Configurable_GeneralSettings.HierarchyLayoutMode.Consecutive:
                    ...
                    if (folderCache.TryGetValue(instanceID, out (Color textColor, int fontSize, FontStyle fontStyle, Color folderColor, HierarchyDesigner_Configurable_Folders.FolderImageType folderImageType) folderInfo))
                    {
        ...
        internal static List<(Component component, Texture2D icon)> GetComponentIcons(GameObject gameObject)
        {
            ...
            foreach (Component component in gameObject.GetComponents<Component>())
            {
                ...
                Texture2D icon = (Texture2D)EditorGUIUtility.ObjectContent(component, component.GetType()).image ?? HierarchyDesigner_Shared_Resources.DefaultTexture;
        ...
        private static void DrawParentTreeFillLines(Transform transform, float rectX, float offsetX, float rectHeight, float rectY)
        {
            ...
            while (parentTransform != null)
            {
                ...
                if (!isLastSibling)
                {
                    GUI.DrawTexture(new(rectX, rectY, rectHeight, rectHeight), HierarchyDesigner_Shared_Resources.GetTreeBranchIconI(treeBranchImageType_I), ScaleMode.ScaleToFit);
                }
        ...
        private static void DrawHierarchyRows(Rect selectionRect)
        {
            ...
            EditorGUI.DrawRect(selectionRect, HierarchyDesigner_Shared_Color.GetRowColor());
        }
        #endregion
        ...
        private static void DrawHierarchyLines(GameObject gameObject, Rect selectionRect)
        {
            ...
            EditorGUI.DrawRect(new(hierarchyWindowOffsetLeft, selectionRect.y + selectionRect.height - hierarchyLineThickness, EditorGUIUtility.currentViewWidth, hierarchyLineThickness), GUI.color);
            GUI.color = activeColor;
        }
        #endregion
        ...
        private static float CalculateButtonsRect(GameObject gameObject, Rect selectionRect)
        {
            switch (layoutMode)
            {
                case HierarchyDesigner_Configurable_GeneralSettings.HierarchyLayoutMode.Consecutive:
                    ...
                    if (folderCache.TryGetValue(gameObject.GetInstanceID(), out (Color textColor, int fontSize, FontStyle fontStyle, Color folderColor, HierarchyDesigner_Configurable_Folders.FolderImageType folderImageType) folderInfo))
                    {
                        GUIStyle folderLabelStyle = FolderStyle;
                        folderLabelStyle.fontSize = folderInfo.fontSize;
                        folderLabelStyle.fontStyle = folderInfo.fontStyle;
        ...
        {
            HierarchyDesigner_Shared_Operations.LockGameObject(gameObject, newState);
        }
        ...
        private static void ProcessHierarchyButtons(GameObject gameObject, Rect selectionRect)
        {
            ...
            {
                ToggleLockState(gameObject, !HierarchyDesigner_Shared_Operations.IsGameObjectLocked(gameObject));
                Event.current.Use();
            }
        ...
        private static void ProcessToggleGameObjectLockStateMajorShortcut(GameObject[] gameObjects)
        {
            ...
            {
                bool isLocked = (gameObject.hideFlags & HideFlags.NotEditable) == HideFlags.NotEditable;
                HierarchyDesigner_Shared_Operations.SetLockState(gameObject, isLocked);
            }
            Event.current.Use();
        }
        ...
        private static void ProcessRenameMajorShortcut()
        {
            ...
            HierarchyDesigner_Window_Rename.OpenWindow(selectedGameObjects, true, 0);
        }
        #endregion
        ...
        private static void DrawFolder(GameObject gameObject, Rect selectionRect, int instanceID)
        {
            if (!folderCache.TryGetValue(instanceID, out (Color textColor, int fontSize, FontStyle fontStyle, Color folderColor, HierarchyDesigner_Configurable_Folders.FolderImageType folderImageType) folderInfo))
            {
                HierarchyDesigner_Configurable_Folders.HierarchyDesigner_FolderData folderData = HierarchyDesigner_Configurable_Folders.GetFolderData(gameObject.name) ?? new HierarchyDesigner_Configurable_Folders.HierarchyDesigner_FolderData();
            ...
            GUI.color = SetBackgroundColorBasedOnState(selectionRect, instanceID);
            GUI.DrawTexture(new(selectionRect.x, selectionRect.y, EditorGUIUtility.currentViewWidth - currentViewWidthOffset, selectionRect.height), folderBackgroundTexture);
            GUI.color = activeColor;
        ...
        {
            string separatorKey = gameObject.name.Replace(HierarchyDesigner_Shared_Constants.SeparatorPrefix, "").Trim();
            if (!separatorCache.TryGetValue(instanceID, out (Color textColor, bool isGradientBackground, Color backgroundColor, Gradient backgroundGradient, int fontSize, FontStyle fontStyle, TextAnchor textAnchor, HierarchyDesigner_Configurable_Separators.SeparatorImageType separatorImageType) separatorInfo))
            {
                HierarchyDesigner_Configurable_Separators.HierarchyDesigner_SeparatorData separatorData = HierarchyDesigner_Configurable_Separators.GetSeparatorData(separatorKey) ?? new HierarchyDesigner_Configurable_Separators.HierarchyDesigner_SeparatorData();
        ...
        public static Dictionary<int, (Color textColor, int fontSize, FontStyle fontStyle, Color folderColor, HierarchyDesigner_Configurable_Folders.FolderImageType folderImageType)> FolderCache
        {
            set
            {
                folderCache = value;
        ...
        public static Dictionary<int, (Color textColor, bool isGradientBackground, Color backgroundColor, Gradient backgroundGradient, int fontSize, FontStyle fontStyle, TextAnchor textAnchor, HierarchyDesigner_Configurable_Separators.SeparatorImageType separatorImageType)> SeparatorCache
        {
            set
            {
