...
{
    internal static class HD_Common_GUI
    {
        #region Properties
        #region Labels
        ...
        private static readonly Lazy<GUIStyle> _primaryPanelStyle = new(() => new()
        {
            ...
            stretchHeight = true,
            margin = new(2, 2, 2, 2),
            normal = { background = HD_Common_Texture.CreateGradientTexture(16, 1024, new Color[] { HD_Common_Color.GetPrimaryPanelColorBottom(), HD_Common_Color.GetPrimaryPanelColorMiddle(), HD_Common_Color.GetPrimaryPanelColorTop() }) }
        });
        ...
        private static readonly Lazy<GUIStyle> _secondaryPanelStyle = new(() => new()
        {
            ...
            margin = new(5, 5, 5, 5),
            normal = { background = HD_Common_Texture.CreateGradientTexture(16, 256, new Color[] { HD_Common_Color.GetSecondaryPanelColorBottom(), HD_Common_Color.GetSecondaryPanelColorTop() }) }
        });
        ...
        private static readonly Lazy<GUIStyle> _tertiaryPanelStyle = new(() => new()
        {
            stretchWidth = true,
            stretchHeight = true,
            normal = { background = HD_Common_Texture.CreateGradientTexture(4, 16, new Color[] { HD_Common_Color.GetSecondaryPanelColorBottom(), HD_Common_Color.GetSecondaryPanelColorTop() }) }
        });
        ...
        private static readonly Lazy<GUIStyle> _headerPanelStyle = new(() => new()
        {
            ...
            padding = new(5, 5, 5, 0),
            margin = new(5, 5, 5, 0),
            normal = { background = HD_Common_Texture.CreateTexture(2, 2, HD_Common_Color.GetSecondaryPanelColorBottom()) }
        });
        ...
        private static readonly Lazy<GUIStyle> _menuPopupPanelStyle = new(() => new()
        {
            ...
            normal = 
            {
                textColor = HD_Common_Color.GetPrimaryFontColor(),
                background = HD_Common_Texture.CreateTexture(2, 2, HD_Common_Color.GetPopupPanelColor())
            },
            hover = new()
            {
                textColor = HD_Common_Color.GetSecondaryFontColor(),
                background = HD_Common_Texture.CreateTexture(2, 2, HD_Common_Color.GetPopupPanelColor())
            },
            active = new()
            {
                textColor = HD_Common_Color.GetSecondaryFontColorFaded(),
                background = HD_Common_Texture.CreateTexture(2, 2, HD_Common_Color.GetPopupPanelColor())
            }
        });
        ...
        private static readonly Lazy<GUIStyle> _inspectorFolderInnerPanelStyle = new(() => new(EditorStyles.helpBox)
        {
            ...
            margin = new(0, 8, 4, 4),
            border = new(2, 2, 2, 2),
            normal = { background = HD_Common_Texture.CreateGradientTexture(2, 4, new Color[] { HD_Common_Color.GetSecondaryPanelColorTop(), HD_Common_Color.GetSecondaryPanelColorBottom() }) }
        });
        ...
        private static readonly Lazy<GUIStyle> _primaryButtonStyle = new(() => new(GUI.skin.button)
        {
            ...
            {
                textColor = HD_Common_Color.GetPrimaryFontColor(),
                background = HD_Common_Texture.ClearTexture
            },
            hover = new()
            {
                textColor = HD_Common_Color.GetSecondaryFontColor(),
        ...
        private static readonly Lazy<GUIStyle> _headerButtonsPanelStyle = new(() => new()
        {
            fixedHeight = 34,
            border = new(2, 2, 2, 2),
            normal = { background = HD_Common_Texture.CreateGradientTexture(2, 32, new Color[] { HD_Common_Color.GetTertiaryPanelColorBottom(), HD_Common_Color.GetTertiaryPanelColorTop() }) }
        });
        ...
        private static readonly Lazy<GUIStyle> _resetButtonStyle = new(() => new(GUI.skin.button)
        {
            ...
            margin = new(0, 0, -2, 0),
            normal = { background = HD_Common_Resources.Icons.Reset }
        });
        ...
        public static Color DrawColorField(string label, float labelWidth, string defaultColorHexCode, Color colorValue, bool showTooltip = false, string tooltipText = "")
        {
            ...
            if (GUILayout.Button(string.Empty, ResetButtonStyle))
            {
                newColor = HD_Common_Color.HexToColor(defaultColorHexCode);
            }
