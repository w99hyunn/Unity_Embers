...
namespace STARTING
{
    public class TitleCharacterUIController : MonoBehaviour
    {
        [Header("Title UI - Manager")]
        public TitleUI titleUI;

        private TitleCharacterUIView _view;
        private TitleCharacterUIModel _model;

        private void Awake()
        {
            TryGetComponent<TitleCharacterUIView >(out _view);
            TryGetComponent<TitleCharacterUIModel>(out _model);
        }
