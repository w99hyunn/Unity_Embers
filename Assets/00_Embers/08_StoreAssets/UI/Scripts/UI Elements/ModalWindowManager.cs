...
namespace Michsky.UI.Reach
{
    ...
    public class ModalWindowManager : MonoBehaviour
    {
        ...
        void InitModalWindow()
        {
            ...
            openStateLength = ReachUIInternalTools.GetAnimatorClipLength(mwAnimator, "ModalWindow_In");
            closeStateLength = ReachUIInternalTools.GetAnimatorClipLength(mwAnimator, "ModalWindow_Out");
        }
