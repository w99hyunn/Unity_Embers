...
-- 테이블 데이터 embers.account:~20 rows (대략적) 내보내기
...
CREATE TABLE IF NOT EXISTS `character` (
  ...
  `hxp` int(11) DEFAULT 0,
  `attack` int(11) NOT NULL DEFAULT 10,
  `class` int(11) NOT NULL DEFAULT 0,
  `gender` int(11) NOT NULL DEFAULT 0,
  `sp` int(11) NOT NULL DEFAULT 0,
  `current_position_x` float DEFAULT 70,
  `current_position_y` float DEFAULT 5,
  `current_position_z` float DEFAULT 65,
...
-- 테이블 데이터 embers.character:~7 rows (대략적) 내보내기
/*!40000 ALTER TABLE `character` DISABLE KEYS */;
REPLACE INTO `character` (`character_id`, `account_id`, `name`, `level`, `faction`, `hp`, `maxHp`, `mp`, `maxMp`, `hxp`, `attack`, `class`, `gender`, `sp`, `current_position_x`, `current_position_y`, `current_position_z`, `mapCode`, `gold`, `inventory_space`, `created_at`) VALUES
	(101, 8, '잉걸불', 1, 0, 100, 100, 50, 50, 0, 10, 0, 0, 0, 66.4808, 6.08424, 68.1936, 1, 0, 20, '2025-01-06 23:23:28'),
	(103, 8, 'dasdasdadASD', 1, 0, 100, 100, 50, 50, 0, 10, 0, 0, 0, 77.0118, 10.8657, 107.198, 1, 0, 20, '2025-01-07 00:52:50'),
	(104, 7, '헬로메이플', 8, 0, 6500, 7570, 4000, 5978, 23800, 110, 1, 0, 0, 75.47, 18.5985, 138.677, 1, 0, 20, '2025-01-09 00:50:35'),
	(105, 7, '행복해요', 1, 0, 100, 100, 50, 50, 0, 10, 0, 0, 0, 71.5449, 17.1675, 132.476, 1, 0, 20, '2025-01-11 04:00:35'),
	(108, 7, '엄준식', 7, 0, 1200, 1200, 1150, 1150, 4150, 65, 1, 1, 0, 120.959, 20.1171, 150.46, 1, 0, 20, '2025-01-11 04:50:49'),
	(109, 28, 'dd', 1, 0, 100, 100, 50, 50, 0, 10, 0, 0, 0, 62.9638, 16.0068, 123.75, 1, 0, 20, '2025-01-12 06:12:25'),
	(110, 28, '', 1, 0, 100, 100, 50, 50, 0, 10, 0, 0, 0, 66.237, 10.4591, 79.5194, 1, 0, 20, '2025-01-12 06:13:00');
...
REPLACE INTO `inventory` (`inventory_id`, `character_id`, `item_id`, `position`, `amount`) VALUES
	(1, 108, 1, 2, 1),
	(2, 108, 5, 3, 1);
